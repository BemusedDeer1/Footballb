...
# -------------------------------------------------------------
# ۱. مینی وب‌سرور اختصاصی سبک برای پاس کردن کامل Health Check
# -------------------------------------------------------------
class SimpleHealthServer(BaseHTTPRequestHandler):
    ...
    def log_message(self, format, *args):
        # جلوگیری از شلوغ شدن لاگ‌ها با ریکوئست‌های هلث‌چک
        return
...
# -------------------------------------------------------------
# ۲. دستورات و کنترلر ربات تلگرام
# -------------------------------------------------------------
...
# -------------------------------------------------------------
# ۳. اجرای همگام وب‌سرور و پولینگ تلگرام
# -------------------------------------------------------------
async def post_init(application: Application):
    await init_db()

def main():
    # ۱. استارت وب‌سرور در پس‌زمینه برای پاس کردن پورت سرور ابری
